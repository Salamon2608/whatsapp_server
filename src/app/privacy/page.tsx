...
export const metadata = {
    title: "Privacy Policy | whatsapp_Server",
    description: "Privacy Policy for whatsapp_Server self-hosted WhatsApp Gateway. Zero-tracking architecture, data ownership, and security practices.",
    openGraph: {
        title: "Privacy Policy | whatsapp_Server",
        description: "Privacy Policy for whatsapp_Server self-hosted WhatsApp Gateway.",
        type: "website",
    },
    twitter: {
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-p:leading-relaxed">
                        ...
                        <p className="lead text-lg text-muted-foreground mb-8">
                            At whatsapp_Server, we believe that your data is your property. This Privacy Policy details the strict boundaries regarding how information is handled when using our self-hosted WhatsApp Gateway.
                        </p>
                        ...
                        <p>
                            Because whatsapp_Server is designed to be <strong>self-hosted</strong>, all core data processing occurs exclusively on the hardware where you deploy the application.
                        </p>
                        <ul>
                            <li><strong>No Centralized Telemetry:</strong> The creators of whatsapp_Server do not receive telemetry, analytics, or usage reports about your WhatsApp interactions.</li>
                        ...
                        <ul>
                            ...
                            <li><strong>WhatsApp Sessions:</strong> whatsapp_Server acts as a bridge to WhatsApp Web. The session tokens (keys) necessary to maintain this connection are stored locally on your server.</li>
                        ...
                        <p>
                            While whatsapp_Server is built with modern security practices, the ultimate safety of your data depends on your hosting environment. We strongly recommend:
                        </p>
                        <ul>
                        ...
                        <p>
                            whatsapp_Server utilizes the <code>@whiskeysockets/baileys</code> library to communicate directly with WhatsApp's servers. By using this gateway, your server will establish a direct web-socket connection to WhatsApp. Please be aware that your use of WhatsApp is still subject to Meta's Privacy Policy.
                        </p>
                        ...
                        <div className="mt-12 p-6 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                            ...
                            <p className="text-sm text-muted-foreground mb-0">If you have specific questions about data handling or security practices, please contact your administrator.</p>
                        </div>
                    </div>
                </div>
            </div>
