...
export const metadata = {
    title: "Terms of Service | whatsapp_Server",
    description: "Terms of Service for whatsapp_Server self-hosted WhatsApp Gateway. Usage guidelines, security requirements, and acceptable use policy.",
    openGraph: {
        title: "Terms of Service | whatsapp_Server",
        description: "Terms of Service for whatsapp_Server self-hosted WhatsApp Gateway.",
        type: "website",
    },
    twitter: {
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-p:leading-relaxed">
                        ...
                        <p className="lead text-lg text-muted-foreground mb-8">
                            Welcome to whatsapp_Server. By accessing or using our WhatsApp Gateway platform, you agree to be bound by these Terms. If you do not agree, please do not use the service.
                        </p>
                        ...
                        <p>
                            Security forms the core of our service. As a self-hosted platform, whatsapp_Server ensures that your data remains strictly within your own infrastructure.
                        </p>
                        <ul>
                        ...
                        <p>
                            When utilizing whatsapp_Server's API, auto-replies, and broadcasting capabilities, you agree to abide by WhatsApp's official Terms of Service and Anti-Spam policies. You agree not to:
                        </p>
                        <ul>
