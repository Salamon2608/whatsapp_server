...
export const TRIGGER_META: Record<AutomationTriggerType, TriggerMeta> = {
  ...
  first_inbound_message: {
    ...
    pillClass: 'border-teal-500/30 bg-teal-500/10 text-teal-400',
  },
  keyword_match: {
    label: 'Keyword Match',
    pillClass: 'border-purple-500/30 bg-purple-500/10 text-purple-400',
  },
  new_contact_created: {
    label: 'New Contact',
  ...
  conversation_assigned: {
    ...
    pillClass: 'border-cyan-500/30 bg-cyan-500/10 text-cyan-400',
  },
  tag_added: {
    label: 'Tag Added',
    pillClass: 'border-amber-500/30 bg-amber-500/10 text-amber-400',
  },
  time_based: {
    label: 'Time-Based',
