# Graph Report - Whatsapp_Server  (2026-09-17)

## Corpus Check
- 298 files · ~483,925 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 13 file(s) not represented in the graph (top: (none) 7, .log 2, .example 1)

## Summary
- 2155 nodes · 4511 edges · 156 communities (138 shown, 16 thin omitted)
...
Cohesion: 0.10
Nodes (31): radix-ui, formatFileSize(), getSenderDisplay(), getTypeBg(), getTypeIcon(), MediaFile, MediaListResponse, MediaPage() (+23 more)

### Community 3 - "cn"
Cohesion: 0.09
Nodes (37): @radix-ui/react-avatar, Contact, InboxPage(), ProfileData, Session, AlertDialogOverlay(), Avatar(), AvatarFallback() (+29 more)

### Community 4 - "chat/actions.ts"
Cohesion: 0.16
Nodes (11): GET(), POST(), POST(), CHAT_PAGE_SIZE, getChatMessages(), sendChatMessage(), sendMediaMessage(), ChatWindow() (+3 more)
...
Cohesion: 0.14
Nodes (24): class-variance-authority, AiConfigForm(), AiKnowledge(), AiPlayground(), SearchFilterProps, FlowCanvasProps, NODE_COLORS, nodeTypes (+16 more)

### Community 8 - "lucide-react"
Cohesion: 0.20
Nodes (17): lucide-react, AutomationLogsPage(), AutomationsPage(), FlowRunsPage(), Notification, TYPE_STYLES, Message, AiUsage() (+9 more)

### Community 9 - "webhook.ts"
Cohesion: 0.12
Nodes (34): pino, GET(), GET(), POST(), batchResolveToPhoneJid(), isLidJid(), normalizeJid(), resolveToPhoneJid() (+26 more)
...
### Community 13 - "react"
Cohesion: 0.18
Nodes (3): react, FlowEditorPage(), FlowEditorShell()

### Community 14 - "canAccessSession"
Cohesion: 0.05
Nodes (60): POST(), PUT(), PUT(), PUT(), POST(), POST(), PUT(), GET() (+52 more)
...
### Community 16 - "📂 Labels"
Cohesion: 0.08
Nodes (25): cURL Example, cURL Example, cURL Example, cURL Example, cURL Example, cURL Example, \[DELETE\] /labels/{sessionId}, \[DELETE\] /labels/{sessionId}/{labelId} (+17 more)
...
Cohesion: 0.08
Nodes (22): bcryptjs, @prisma/client, bcrypt, prisma, { PrismaClient }, GET(), POST(), DELETE() (+14 more)

### Community 25 - "button.tsx"
Cohesion: 0.15
Nodes (6): @radix-ui/react-slot, ERROR_CONFIGS, ErrorConfig, metadata, Button(), ButtonProps
...
Cohesion: 0.05
Nodes (47): DELETE(), dynamic, GET(), POST(), DELETE(), dynamic, GET(), PUT() (+39 more)
...
### Community 39 - "📂 Knowledge Base Index"
Cohesion: 0.50
...
Cohesion: 0.19
Nodes (10): DELETE(), GET(), MEDIA_DIR, parseFilename(), dynamic, GET(), POST(), DashboardPage() (+2 more)
...
Cohesion: 0.07
Nodes (30): date-fns, moment-timezone, react-virtuoso, socket.io-client, BroadcastPage(), ChatContact, ChatListProps, ChatRow() (+22 more)
...
### Community 117 - "\[POST\] /labels/{sessionId}"
Cohesion: 0.33
Nodes (6): cURL Example, Headers, Parameters, \[POST\] /labels/{sessionId}, Request Body (`application/json`), Responses

### Community 118 - "prisma.ts"
Cohesion: 0.06
Nodes (35): socket.io, @whiskeysockets/baileys, dynamic, GET(), registerSchema, dynamic, GET(), dynamic (+27 more)
...
### Community 144 - "webhooks/page.tsx"
Cohesion: 0.09
Nodes (45): sonner, BotSettingsPage(), BroadcastLog, BroadcastProgress, BroadcastRecipient, ContactListPage(), Group, GroupsPage() (+37 more)

### Community 145 - "\[PUT\] /labels/{sessionId}/{labelId}"
Cohesion: 0.33
Nodes (6): cURL Example, Headers, Parameters, \[PUT\] /labels/{sessionId}/{labelId}, Request Body (`application/json`), Responses

### Community 146 - "auth.ts"
Cohesion: 0.07
Nodes (21): config, next-auth, POST(), ChatWithJidPage(), ChatPage(), authConfig, ChatInterface(), ChatInterfaceProps (+13 more)

### Community 150 - "\[PUT\] /labels/{sessionId}/chat/{jid}/labels"
Cohesion: 0.33
Nodes (6): cURL Example, Headers, Parameters, \[PUT\] /labels/{sessionId}/chat/{jid}/labels, Request Body (`application/json`), Responses
...
### Community 152 - "\[DELETE\] /autoreplies/{sessionId}"
Cohesion: 0.40
...
- **Why does `WhatsApp AI Gateway — Complete API Reference` connect `WhatsApp AI Gateway — Complete API Reference` to `📂 Chat`, `📂 Labels`, `📂 Sessions`, `\[DELETE\] /autoreplies/{sessionId}`, `📂 Webhooks`, `\[GET\] /chats/by-label/{labelId}`, `📂 Scheduler`, `📂 Users`, `📂 Profile`, `\[POST\] /status/{sessionId}/update`, `📂 Notifications`, `\[POST\] /autoreplies/{sessionId}`, `\[POST\] /auth/register`, `docs/README.md`, `📦 Schemas`, `\[DELETE\] /sessions/{sessionId}/access`, `📂 Messaging`, `Verify Examples`, `\[POST\] /contacts/{sessionId}/{jid}/block`, `📂 Groups`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `scheduler/page.tsx`, `chat/actions.ts`, `flow-canvas.tsx`, `lucide-react`, `dashboard/page.tsx`, `sheet.tsx`, `dashboard/layout.tsx`, `form.tsx`, `chat-list.tsx`, `webhooks/page.tsx`, `use-theme.tsx`, `button.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `lucide-react` to `scheduler/page.tsx`, `cn`, `package.json`, `flow-canvas.tsx`, `dashboard/page.tsx`, `sheet.tsx`, `dashboard/layout.tsx`, `react`, `form.tsx`, `webhooks/page.tsx`, `chat-list.tsx`, `auth.ts`, `privacy/page.tsx`, `terms/page.tsx`, `use-theme.tsx`, `button.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
